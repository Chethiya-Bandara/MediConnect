        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">
              Pharmacy Admin Identity
            </h2>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Signed-in operational account details from the auth provider.
            </p>
          </div>
        </div>
      ...
      <article className="rounded-[1.8rem] border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Privacy and billing guardrails for the pharmacy admin role.
            </p>
          </div>
        </div>
