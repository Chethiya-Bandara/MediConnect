  ...
  return (
    <div className="min-h-screen bg-surface text-slate-900 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100">
      ...
      <main className="flex min-h-screen flex-col md:ml-64">
        <header className="fixed left-0 right-0 top-0 z-30 flex items-center justify-between border-b border-slate-100 bg-white/85 px-4 py-4 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/80 md:left-64 md:px-8">
          ...
          <div className="flex items-center gap-3 border-l border-slate-200 pl-4 dark:border-slate-700">
            ...
            <button type="button" onClick={() => setPage("settings")} className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-white bg-slate-200 text-sm font-black tracking-[0.08em] text-slate-700 shadow-sm dark:border-slate-800 dark:bg-slate-700 dark:text-slate-100">
              {profilePhoto ? (
                <img src={profilePhoto} alt={`${displayName} avatar`} className="h-full w-full object-cover" />
              ) : (
              ...
              >
                <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_340px]">
                  ...
                  <aside className="rounded-[1.6rem] border border-slate-200 bg-slate-50/80 p-5 dark:border-slate-700 dark:bg-slate-800/40">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-400 dark:text-slate-500">Quick help</p>
            ...
            <section className="space-y-6">
              <div className="grid grid-cols-1 gap-4 2xl:grid-cols-3 xl:grid-cols-2">
                {records.length === 0 ? (
                  ...
                  records.map((record) => (
                    <article key={record.id} className="flex h-full flex-col rounded-[1.7rem] border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            {selectedRecord?.id === record.id && modal === "record" ? "Opened" : "Open Record"}
                          </button>
                        </div>
                      </div>
              ...
              <div className="grid grid-cols-1 gap-4 2xl:grid-cols-3 xl:grid-cols-2">
                {appointments.length === 0 ? (
                  ...
                  appointments.map((item) => (
                    <article key={item.id} className="flex h-full flex-col rounded-[1.7rem] border border-slate-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <span className={`w-fit rounded-full px-3 py-1 text-xs font-bold ${statusTone(item.status)}`}>{formatStatusLabel(item.status)}</span>
                      </div>
                  ...
                  <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <h2 className="mt-3 font-headline text-xl font-extrabold text-slate-900 dark:text-white sm:text-2xl">{displayName}</h2>
                      </div>
                    </div>
                    <button
                      type="button"
                ...
                <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,0.95fr)]">
                  <div className="rounded-[1.55rem] border border-slate-200/80 bg-slate-50/55 p-5 dark:border-slate-700/70 dark:bg-slate-800/35">
                    ...
                    <label className="mt-6 block">
                      <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Full name</span>
                      <input
                        type="text"
                        value={profileName}
                  ...
                  <article className="rounded-[1.55rem] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(241,245,249,0.9))] p-5 shadow-sm dark:border-slate-700/70 dark:bg-[linear-gradient(180deg,rgba(30,41,59,0.84),rgba(15,23,42,0.82))]">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <h3 className="mt-2 font-headline text-lg font-extrabold text-slate-900 dark:text-white sm:text-xl">User details</h3>
                      </div>
                      <div className="rounded-2xl border border-slate-200 bg-white p-3 text-slate-500 shadow-sm dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
                        <Fingerprint size={18} />
                      </div>
                    ...
                    <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200/80 bg-white/90 dark:border-slate-700 dark:bg-slate-900/80">
                      <div className="flex items-start gap-3 border-b border-slate-200/80 px-4 py-4 dark:border-slate-700">
                        ...
                        <div className="min-w-0">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Primary email</p>
                          <p className="mt-2 break-all text-sm font-semibold text-slate-900 dark:text-white">{overview.user.email}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3 border-b border-slate-200/80 px-4 py-4 dark:border-slate-700">
                        ...
                        <div className="min-w-0">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Digital health ID</p>
                          <p className="mt-2 font-headline text-xl font-extrabold tracking-[0.08em] text-primary dark:text-blue-300">{overview.patient.dhid}</p>
                        </div>
                      </div>

                      <div className="flex items-start gap-3 px-4 py-4">
                        <ShieldCheck size={16} className="mt-0.5 text-slate-400 dark:text-slate-500" />
                        <div className="min-w-0">
                          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">Issued</p>
                          <p className="mt-2 text-sm font-medium text-slate-600 dark:text-slate-300">{formatDateTime(overview.patient.created_at)}</p>
                        </div>
                      </div>
                    </div>
                  </article>
          ...
          <div className="w-full max-w-[70rem] rounded-[2.2rem] border border-slate-200/80 bg-white p-6 shadow-[0_32px_90px_rgba(2,6,23,0.45)] dark:border-slate-700/90 dark:bg-slate-900 sm:p-8">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-2 font-headline text-2xl font-extrabold text-slate-900 dark:text-white">Digital Health ID</h3>
              </div>
              <button
                type="button"
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              ...
              <button type="button" onClick={() => void downloadQrCode()} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-100 px-4 py-3.5 font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-100">
                <span className="inline-flex items-center gap-2">
                  <Download size={16} />
                  Download QR
                </span>
              </button>
              <button type="button" onClick={() => setModal(null)} className="rounded-2xl bg-slate-100 px-4 py-3.5 font-bold text-slate-700 dark:bg-slate-800 dark:text-slate-100">Close</button>
            </div>
          </div>
        </div>
      ) : null}
      ...
      {modal === "record" && selectedRecord ? (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-md" onClick={(event) => event.target === event.currentTarget && setModal(null)}>
          <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white shadow-[0_32px_90px_rgba(2,6,23,0.48)] dark:border-slate-700/90 dark:bg-slate-900">
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 pb-5 pt-6 dark:border-slate-800 md:px-8">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-400">Open Record</p>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 md:px-8">
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-[1.35rem] border border-slate-200 bg-slate-50/80 p-4 dark:border-slate-700 dark:bg-slate-800/45">
                  ...
                  <p className="mt-2 text-base font-bold text-slate-900 dark:text-white">{selectedRecord.doctor.name}</p>
                </div>
                <div className="rounded-[1.35rem] border border-slate-200 bg-slate-50/80 p-4 dark:border-slate-700 dark:bg-slate-800/45">
                  <p className="text-[10px] uppercase tracking-[0.22em] text-slate-400">Organisation</p>
                  <p className="mt-2 text-base font-bold text-slate-900 dark:text-white">{selectedRecord.organisation.name || "Not linked"}</p>
                </div>
                <div className="rounded-[1.35rem] border border-slate-200 bg-slate-50/80 p-4 dark:border-slate-700 dark:bg-slate-800/45">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <p className="text-[10px] uppercase tracking-[0.22em] text-slate-400">Prescriptions</p>
                      <p className="mt-2 text-base font-bold text-slate-900 dark:text-white">{selectedRecord.prescriptions.length}</p>
                    </div>
                  ...
                  {selectedRecord.prescriptions.length === 0 ? (
                    ...
                    <div className="mt-4 space-y-4">
                      {selectedRecord.prescriptions.map((prescription) => (
                        <div key={prescription.id} className="rounded-[1.25rem] border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                            <div>
